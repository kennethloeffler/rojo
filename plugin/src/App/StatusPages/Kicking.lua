...
local Kicking = Roact.Component:extend("Kicking")

function Kicking:init()
	self.contentSize, self.setContentSize = Roact.createBinding(Vector2.new(0, 0))
end

function Kicking:render()
...
local KickingPage = Roact.Component:extend("KickingPage")

function KickingPage:init()
	self.containerSize, self.setContainerSize = Roact.createBinding(Vector2.new(0, 0))
end

function KickingPage:render()
	return Roact.createElement("Frame", {
		...
		Buttons = e("Frame", {
			...
			Yes = e(TextButton, {
				...
				transparency = self.props.transparency,
				layoutOrder = 2,
				onClick = self.props.onKick,
			}, {
				Tip = e(Tooltip.Trigger, {
					text = "Stop current user's sync",
				}),
			}),
...
function KickingPage.getDerivedStateFromProps(props)
